...
# piyush shubham director
# soumya prohram manager

# ankes ritik raj member
...
with open("batch-8.json", 'r') as file:
...
def scrape_lawyers_links():
    ...
    for i in range(PAGE_NUM, len(firm_urls)):
        ...
        try:
            ...
            top_spots_el = top_spots_el.find_elements(By.CLASS_NAME,
                                                      'full-name.fw-bold.mb-0.text-center.text-lg-start .directory_profile')
        ...
        try:
            ...
            spotlights_el = spotlights_el.find_elements(By.CLASS_NAME,
                                                        'full-name.fw-bold.mb-0.text-center.text-lg-start .directory_profile')
        ...
        try:
            ...
            poap_results_el = poap_results_el.find_elements(By.CLASS_NAME,
                                                            'full-name.fw-bold.mb-0.text-center.text-lg-start .directory_profile')
...
def scrape_lawyer_data(urls, page_num):
    ...
    for i in range(LAWYER_DATA, len(urls)):
        ...
        try:
            firm_name = driver.find_element(By.CLASS_NAME,
                                            'profile-info-card .profile-profile-header.d-none.d-xl-block.paragraph-large-xl.mb-0.mb-xl-3')
            if firm_name:
